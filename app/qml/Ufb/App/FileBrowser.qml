...
Rectangle {
    ...
    // UfbMenu, not Menu: this menu is long enough to need clamping
    // mid-screen, which is exactly the case that hung the app — see
    // UfbMenu.qml for the mechanism.
    UfbMenu {
        id: fileMenu
            ...
            Row {
                ...
                Item {
                    ...
                    Rectangle {
                        ...
                        anchors.bottomMargin: 4
                        width: 2
                        color: sizeHandleMaHover.hovered || sizeHandleMa.pressed
                            ? Theme.colors.accent : Theme.colors.borderStrong
                        z: 10
                    }
                    MouseArea {
